                                ...
                                @forelse($users as $user)
                                    <tr>
                                            ...
                                            <div class="px-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    <span
                                                        ...
                                                        <span
                                                            class="font-medium text-sm text-gray-800 dark:text-neutral-200">{{ strtoupper(substr($user->name, 0, 1)) }}</span>
                                                    </span>
                                                    <div class="grow">
                                                        <span
                                        ...
                                        <td class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ ucfirst($user->access_type ?? '-') }}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
